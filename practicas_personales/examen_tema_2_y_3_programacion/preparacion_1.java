...
//-----------------------------------------------------------------------------------------------------------------------------------------
    ...
    static void ejercicio10(){
        Scanner sc = new Scanner(System.in);
        boolean sw =false;
        System.out.println("dame un caracter y te dire si es vocal");
        String caracter = sc.next();
        
            while (sw==false){
                if(caracter.length()>1){
                    System.out.println("dame un solo caracter y te dire si es vocal");
                    caracter = sc.next();
                }else{
                    sw=true;
                }
            }
        char verfi_caracter=caracter.charAt(0);
